...
public class Events {
	...
	public void TestApp() {
		...
		JLabel labelAnswer = new JLabel("Answer: " + answer);
		...
		startgame.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				labelAnswer.setText("Answer: " + answer);
				rd(3);
			}
		...
		labelAnswer.setBounds(100, 10, 150, 30);
